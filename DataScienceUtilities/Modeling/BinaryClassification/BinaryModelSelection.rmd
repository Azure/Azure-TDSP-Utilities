...
## Vilter train and test data-sets by same countries
trainData <- trainData[trainData[,'country'] %in% intersect(unique(trainData$country), unique(testData$country)),]
testData <- testData[testData[,'country'] %in% intersect(unique(trainData$country), unique(testData$country)),]
